    ...
    : host(hostProcess)
{
    ...
    commands.emplace_back(CommandStrings {"beta"}, "set AHRS algorithm gain: <value>", [this]() { Program::getInstance().getRobot()->pAHRS->setBeta(getArgument<float>(0.0f, 20.0f, 5.0f)); });
}
