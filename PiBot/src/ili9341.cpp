...
{
    writeDataRequest(Ili9341Registers::SWRESET, std::vector<uint8_t>{});
    std::this_thread::sleep_for(std::chrono::milliseconds(200));
//    writeDataRequest(Ili9341Registers::0xEF, std::vector<uint8_t>{0x03, 0x80, 0x02});
//    writeDataRequest(Ili9341Registers::0xCF, std::vector<uint8_t>{0x00, 0XC1, 0X30});
//    writeDataRequest(Ili9341Registers::0xED, std::vector<uint8_t>{0x64, 0x03, 0X12, 0X81});
//    writeDataRequest(Ili9341Registers::0xE8, std::vector<uint8_t>{0x85, 0x00, 0x78});
//    writeDataRequest(Ili9341Registers::0xCB, std::vector<uint8_t>{0x39, 0x2C, 0x00, 0x34, 0x02});
//    writeDataRequest(Ili9341Registers::0xF7, std::vector<uint8_t>{0x20});
//    writeDataRequest(Ili9341Registers::0xEA, std::vector<uint8_t>{0x00, 0x00});
...
//    writeDataRequest(Ili9341Registers::0xF2, std::vector<uint8_t>{0x00});
    ...
    writeDataRequest(Ili9341Registers::SLPOUT, std::vector<uint8_t>{}); //Exit Sleep
    std::this_thread::sleep_for(std::chrono::milliseconds(120));
    writeDataRequest(Ili9341Registers::DISPON, std::vector<uint8_t>{}); //Display on
}
